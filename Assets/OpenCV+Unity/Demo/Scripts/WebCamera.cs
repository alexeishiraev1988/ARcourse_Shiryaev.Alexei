namespace OpenCvSharp.Demo
{
	...
	public abstract class WebCamera: MonoBehaviour
	{
		...
		protected RectTransform _surfaceRectTransform;
		...
		protected virtual void Awake()
		{
			...
			_rawImage = Surface.GetComponent<RawImage>();
			_surfaceRectTransform = Surface.GetComponent<RectTransform>();
		}
		...
		private void RenderFrame()
		{
			...
			{
				// apply
				_rawImage.texture = renderedTexture;

				// Adjust image ration according to the texture sizes 
				_surfaceRectTransform.sizeDelta = new Vector2(renderedTexture.width, renderedTexture.height);
			}
		}
	}
}